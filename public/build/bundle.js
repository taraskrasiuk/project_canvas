...
var _BoardView = __webpack_require__(11);
...
var _BoundBox = __webpack_require__(31);

var _BoundBox2 = _interopRequireDefault(_BoundBox);

var _PaintObject2 = __webpack_require__(7);
...
var _BoardController = __webpack_require__(25);

var _BoardController2 = _interopRequireDefault(_BoardController);

var _BoardModel = __webpack_require__(26);

var _BoardModel2 = _interopRequireDefault(_BoardModel);

var _Bottom_View = __webpack_require__(12);
...
var BoardView = function (_View) {
    ...
    _createClass(BoardView, [{
        ...
        value: function renderBottomPanel() {
            var currentView = this.controller.getCurrentView();
            var bottom = new _Bottom_View2.default();
            if (currentView != null) {
        ...
        value: function renderAsidePanel() {
            ...
            var buttons = [{
                ...
                onClick: function onClick(e) {
                    e.preventDefault();
                    _this2.handleSelect(e.target.textContent);
                }
            }, {
                name: "PDF",
                onClick: function onClick(e) {
            ...
            buttons.forEach(function (btn) {
                var b = (0, _jquery2.default)("<button></button>", {
                    "class": "button",
                    text: btn.name
                }).on("click", btn.onClick.bind(_this2)).appendTo(asidePanel);
            });
            return asidePanel;
        }
    }, {
        ...
        value: function render() {
            ...
            var bottom = this.renderBottomPanel();
...
var Bottom_View = function (_View) {
    ...
    function Bottom_View() {
        ...
        var _this = _possibleConstructorReturn(this, (Bottom_View.__proto__ || Object.getPrototypeOf(Bottom_View)).call(this, { className: "bottom-wrapper", active: true }));
    ...
    _createClass(Bottom_View, [{
        ...
        value: function renderItem() {
            ...
            if (type == "button") {
                ...
                return new _FileUploadField2.default({ name: label, onUpload: onUpload != null ? onUpload : null, value: "" }).render(function (e) {
                    console.log(e);
                });
            } else if (type == "link") {
                return (0, _jquery2.default)("<a donwload='canvas.png' href='#'>download</a>", {
                    "class": "button",
                    text: label
...
var _ToolsView = __webpack_require__(44);
...
var _PaintControls = __webpack_require__(30);
...
var _Canvas_Context = __webpack_require__(27);

var _Canvas_Context2 = _interopRequireDefault(_Canvas_Context);

var _ShapesHolder = __webpack_require__(29);
...
var _InputField2 = __webpack_require__(4);
...
var PDF_Model = function (_PaintState) {
    ...
    _createClass(PDF_Model, [{
        ...
        key: "loadFileFromSource",
        value: function loadFileFromSource() {}
    }, {
        key: "loadFile",
        value: function loadFile(cb) {
            var self = this;
        ...
        key: "queueRenderPage",
        value: function queueRenderPage(num, cb) {
...
var _resizable = __webpack_require__(53);
...
var _AppController = __webpack_require__(23);

var _AppController2 = _interopRequireDefault(_AppController);

var _AppModel = __webpack_require__(24);
    ...
    function AppView() {
        ...
        _this.controller = new _AppController2.default({
            model: new _AppModel2.default({
                id: "mainApp",
                boards: [new _BoardView2.default({
                    name: "Board 1"
                })]
            })
        });
    ...
    _createClass(AppView, [{
        ...
        value: function render(id) {
            ...
            if (this.controller.getCu != null) {
                (0, _jquery2.default)(content).append(this._currentBoard.render());
            }
            if (id != null) {
                (0, _jquery2.default)(main).append(topPanel, content).appendTo(targetElement);
            } else {
                (0, _jquery2.default)(main).append(topPanel, content).appendTo("body");
            }
            (0, _resizable2.default)({}, (0, _jquery2.default)(main));
        }
    }, {
        key: 'topDrag',
        ...
        value: function renderTopPanel() {
            ...
            var self = this;
            var topPanel = (0, _jquery2.default)(_Constants.ELEMENT_DIV, {
                "class": "top-panel"
            }).append(this.topDrag());
            var topPanelHead = (0, _jquery2.default)("<h3></h3>", {
                "class": "top-panel_head",
                text: "Board"
            }).appendTo(topPanel);
            var ul = (0, _jquery2.default)(_Constants.ELEMENT_UL, {
                "class": "top-panel_list"
            }).appendTo(topPanel);
            var liArray = this.controller.model.getBoards().map(function (el, idx) {
                var span = (0, _jquery2.default)("<span></span>", {
                    "class": "close",
                    "text": "x"
                }).on("click", function (e) {
                    self.controller.deleteBoard(el, _this2.update.bind(_this2));
                    _this2.update();
                });
                var li = (0, _jquery2.default)("<li></li>", {
                    ...
                    self.controller.setCurrentBoard(el, _this2.update.bind(_this2));
            ...
            if (this.controller.model.getBoards().length < this.controller.model.getMaxBoards()) {
                var addSpan = (0, _jquery2.default)("<li></li>", {
                    ...
                    self.controller.addBoard(new _BoardView2.default({ name: "Board " + (self.controller.model.getBoards().length + 1) }), _this2.update.bind(_this2));
                });
        ...
        value: function update(board) {
            ...
            (0, _jquery2.default)(main).append(topPanel, content);
        }
    }]);
...
var _PaintView = __webpack_require__(28);

var _PaintView2 = _interopRequireDefault(_PaintView);

var _PDF_View = __webpack_require__(46);
...
var BoardModel = function () {
    function BoardModel() {
        ...
        var PAINT_VIEW = "Paint";
        var PDF_VIEW = "PDF";
        this.name = props.name;
        this._id = props.id;
        this.views = (_views = {}, _defineProperty(_views, PAINT_VIEW, new _PaintView2.default({ elementId: "content", tools: ["brush", "shapes", "background", "erase", "select"] })), _defineProperty(_views, PDF_VIEW, new _PDF_View2.default({ id: "canvas", tools: ["brush"] })), _views);
    }
...
var _PaintObject = __webpack_require__(7);
...
var _Pencil = __webpack_require__(34);
...
var _Ellipsis = __webpack_require__(33);

var _Ellipsis2 = _interopRequireDefault(_Ellipsis);

var _Triangle = __webpack_require__(36);
...
var _DropDownOption = __webpack_require__(39);
...
var _ToolsModel = __webpack_require__(43);
...
var _ToolsController = __webpack_require__(42);
    ...
    _createClass(ToolsView, [{
        ...
        value: function render() {
            ...
            if (this.controller.getCurrentTool() != null) {
                var topDrag = (0, _jquery2.default)(_Constants.ELEMENT_DIV, {
                    "class": "topDrag"
                });

                var appendTo = (0, _jquery2.default)(".tools-wrapper").parent();
                ...
                (0, _draggable2.default)({
                    ...
                    drag: function drag(event, ui) {
                        ...
                        (0, _jquery2.default)(".tools-absolute").css({ left: ui.position.left, top: ui.position.top });
                    }
                }, topDrag);
                ...
                }).append(topDrag, this.renderToolDropDown(), this.renderToolOptions()).appendTo(wrapper);
            }
...
var PDF_Controller = function (_PaintController) {
    ...
    _createClass(PDF_Controller, [{
        ...
        value: function _callback(page) {
            ...
            var b = page.render(renderContext);
        ...
        value: function getFile(fileName, cb) {
            ...
            cb(function () {
                return _this2.model.getTotalPages();
            });
        }
    }, {
        key: "update",
        ...
        value: function nextPage(cb) {
            ...
            cb(function () {
                return _this3.model.getCurrentPageNum();
            });
        }
    }, {
        key: "prevPage",
        value: function prevPage(cb) {
            var _this4 = this;

            var self = this;
            this.model.getPrev(this._callback.bind(this));
            cb(function () {
                return _this4.model.getCurrentPageNum();
            });
        }
    }, {
        key: "getAmounOfPages",
        value: function getAmounOfPages() {
...
var _PDF_Contoller = __webpack_require__(45);
...
var PDF_Vew = function (_Canvas_View) {
    ...
    function PDF_Vew() {
        ...
        _this.bottomItems = [{
            ...
            onClick: function onClick(e) {
                e.preventDefault();
                _this.controller.getFile("ng-book.pdf", function (pages) {
                    _this.totalPages = pages;
                    var total = (0, _jquery2.default)("<span></span>", {
                        text: _this.totalPages,
                        id: "totalPages"
                    });
                    (0, _jquery2.default)(".pdf-wrapper").prepend(total);
                });
            },
            className: "bottom-button"
        }, {
            ...
            onClick: function onClick(e) {
                e.preventDefault();
                _this.controller.scale = _this.controller.scale - .2;
