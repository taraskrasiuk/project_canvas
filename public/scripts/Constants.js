...
export const ELEMENT_SPAN = "<span></span>";
export const ELEMENT_HEADER = "<h3></h3>";
export const ELEMENT_UL = "<ul></ul>";
export const ELEMENT_LI = "<li></li>";
export const ELEMENT_IMG = "<img />";
export const ELEMENT_BTN = "<button></button>";
