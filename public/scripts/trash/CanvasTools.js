...
CanvasTools.toolsColors = [
	COLOR_BACKGROUND, COLOR_FILL_STYLE, COLOR_STROKE_STYLE
];
...
const sameSet = {
	[TOOLS_GROUP_COLORS]: [COLOR_FILL_STYLE, COLOR_STROKE_STYLE, COLOR_BACKGROUND],
...
CanvasTools.sets = {
	...
	[BRUSH_TOOL]: {
		"subSet": ["pencil", "brush"]
		// [TOOLS_GROUP_COLORS]: [COLOR_STROKE_STYLE, COLOR_BACKGROUND, COLOR_LINE_COLOR],
...
CanvasTools.subSets = {
	"brush": {
		[TOOLS_GROUP_COLORS]: [COLOR_STROKE_STYLE, COLOR_LINE_COLOR],
		[TOOLS_GROUP_TRANSFORMS]: [TRANSFORM_WIDTH_STROKE, TRANSFORM_WIDTH_LINE, "globalAlpha"]
	},
	"pencil": {
		[TOOLS_GROUP_COLORS]: [COLOR_STROKE_STYLE],
		[TOOLS_GROUP_TRANSFORMS]: [TRANSFORM_WIDTH_LINE, "globalAlpha"]
	}
}
//SETS SUBTOOLS
const BRUSH_T = "Brush";
const SUB_TOOL_BRUSH = "brush";
const SUB_TOOL_PENCIL = "pencil";
CanvasTools.SETS = {
		[BRUSH_T]: {
			name: "Brush",
			subTools: {
				[SUB_TOOL_BRUSH]: {
					[TOOLS_GROUP_COLORS]: ["strokeStyle"],
					[TOOLS_GROUP_TRANSFORMS]: [TRANSFORM_WIDTH_STROKE, TRANSFORM_WIDTH_LINE, "globalAlpha"]
				},
				// [SUB_TOOL_PENCIL]: {
				// 	[TOOLS_GROUP_COLORS]: ["strokeStyle"],
		...
		"Shapes" : {
			...
			subTools: {
				"Rectangle": {
					[TOOLS_GROUP_COLORS]: [COLOR_STROKE_STYLE, COLOR_FILL_STYLE],
					[TOOLS_GROUP_TRANSFORMS]: [TRANSFORM_WIDTH_STROKE, "globalAlpha"],
					"fill": ["fillShape"]
				},
				"Circle": {
					[TOOLS_GROUP_COLORS]: [COLOR_STROKE_STYLE, COLOR_FILL_STYLE],
		...
		"Background" : {
			...
			subTools: {
				"Background" : {
					[TOOLS_GROUP_COLORS]: [COLOR_BACKGROUND],
                    ["file"]: ["upload"],
                    ["download"]: ["download"]
				}
			}
